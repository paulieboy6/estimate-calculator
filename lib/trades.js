import { Hammer, Fence, Layers, Bath, ChefHat, Home, HousePlus } from "lucide-react";

const REMODEL_NOTE =
  "Remodel pricing varies significantly based on layout changes, plumbing/electrical work, and material choices — this range is a starting point only.";
...
export const TRADES = {
  ...
  bathroom_remodel: {
    ...
    low: 125,
    high: 450,
    fields: [{ key: "size", label: "Bathroom size", suffix: "sq ft", placeholder: "e.g. 50" }],
    tiers: [
      { key: "basic", label: "Basic", low: 100, high: 150 },
      { key: "midrange", label: "Mid-range", low: 200, high: 300 },
      { key: "highend", label: "High-end", low: 400, high: 500 },
    ],
    note: REMODEL_NOTE,
  },
  kitchen_remodel: {
    ...
    low: 150,
    high: 400,
    fields: [{ key: "size", label: "Kitchen size", suffix: "sq ft", placeholder: "e.g. 200" }],
    tiers: [
      { key: "basic", label: "Basic", low: 125, high: 175 },
      { key: "midrange", label: "Mid-range", low: 225, high: 325 },
      { key: "highend", label: "High-end", low: 350, high: 450 },
    ],
    note: REMODEL_NOTE,
  },
  whole_home_remodel: {
    ...
    low: 100,
    high: 200,
    fields: [{ key: "size", label: "Home size", suffix: "sq ft", placeholder: "e.g. 1800" }],
    tiers: [
      { key: "basic", label: "Basic", low: 85, high: 115 },
      { key: "midrange", label: "Mid-range", low: 130, high: 170 },
      { key: "highend", label: "High-end", low: 180, high: 220 },
    ],
    note: REMODEL_NOTE,
  },
  room_addition: {
    ...
    low: 200,
    high: 400,
    fields: [{ key: "size", label: "Addition size", suffix: "sq ft", placeholder: "e.g. 300" }],
    tiers: [
      { key: "basic", label: "Basic", low: 175, high: 225 },
      { key: "midrange", label: "Mid-range", low: 265, high: 335 },
      { key: "highend", label: "High-end", low: 350, high: 450 },
    ],
    note: REMODEL_NOTE,
  },
